<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Шапка', 'redux-framework-demo' ),
        'id'               => 'globalsettings-header',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'Описание опций', 'redux-framework-demo' ),
        'fields'           => array(
            array(
                'id'       => 'phone',
                'type'     => 'text',
                'title'    => __( 'Номер телефона', 'redux-framework-demo' ),
                'subtitle' => __( 'Введите номер', 'redux-framework-demo' ),
                'desc'     => __( 'В международном формате', 'redux-framework-demo' ),
                'default'  => '8 (800) 444 44 44',
            ),
            array(
                'id'       => 'logo',
                'type'     => 'media',
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Подвал', 'redux-framework-demo' ),
        'id'               => 'globalsettings-footer',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => __( 'Описание опций', 'redux-framework-demo' ),
        'fields'           => array(
            array(
                'id'       => 'link',
                'type'     => 'text',
                'title'    => __( 'Ссылка', 'redux-framework-demo' ),
                // 'subtitle' => __( 'Введите номер', 'redux-framework-demo' ),
                // 'desc'     => __( 'В международном формате', 'redux-framework-demo' ),
                'default'  => '',
            ),
